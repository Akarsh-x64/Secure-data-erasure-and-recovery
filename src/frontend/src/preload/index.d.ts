...
declare global {
  ...
  interface WindowControlsAPI {
    ...
    createTestImage?: (options?: { filesystem?: string; sizeMb?: number; label?: string }) => Promise<{ success: boolean; message?: string; vhdPath?: string; filesystem?: string; error?: string }>
