        ...
        <div className="flex flex-col gap-4">
          <section className="rounded-lg border border-ui-outline bg-background-sidebar p-4">
            ...
            <button
              ...
              className="mt-4 flex w-full items-center justify-center gap-2 rounded-md border border-button-primary bg-button-primary px-3 py-3 text-sm font-medium text-button-primary-text transition-colors hover:bg-button-primary/85 disabled:cursor-not-allowed disabled:border-ui-outline disabled:bg-ui-selection disabled:text-text-muted"
            >
            ...
            <div className="space-y-4 p-4">
              ...
              <div className="flex justify-end gap-2 pt-1">
                ...
                <button
                  ...
                  disabled={!canConfirm}
                  onClick={startErase}
                  className="rounded-md border border-button-primary bg-button-primary px-3 py-2 text-sm font-medium text-button-primary-text transition-colors hover:bg-button-primary/85 disabled:cursor-not-allowed disabled:border-ui-outline disabled:bg-ui-selection disabled:text-text-muted"
                >
                  Execute erase
                </button>
              </div>
